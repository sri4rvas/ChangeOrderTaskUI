					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Change Order Approval Form",
									"targetURL": "#coinboxui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coinboxui-display": {
								"semanticObject": "coinboxui",
								"action": "display",
								"description": "Change Order Approval workflow task UI application",
								"title": "Change Order Approval Form",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coinboxui",
									"url": sap.ui.require.toUrl("coinboxui")
								}
							}
						}
					}
